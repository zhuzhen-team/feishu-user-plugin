...
[![Tools](https://img.shields.io/badge/Tools-83-orange.svg)](#tools)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](CONTRIBUTING.md)

**All-in-one Feishu/Lark MCP Server -- 83 tools, 9 skills, 3 auth layers for messaging, docs, bitable, calendar, tasks, drive, OKR, and more.**
